-- ============================================================
-- StowFlow — Schéma MPD complet (Option B, référence rapport)
-- ============================================================
--
-- Où exécuter : connecté à la base "stowflow" (pas "postgres").
--
-- Prérequis : la base stowflow existe (voir init-db.sql).
--
-- Alternative recommandée : ne pas exécuter ce fichier — laisser Hibernate
-- créer/mettre à jour les tables au démarrage de l'API (Option A).
-- ============================================================

-- Tenants (espaces clients SaaS)
